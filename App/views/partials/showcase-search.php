    ...
    <div class="container mx-auto text-center z-10">
        ...
        <form method="GET" action="/listings/search" class="mb-4 block mx-5 md:mx-auto">
            <input
                ...
                class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none" value="<?= isset($_GET['keywords']) ? htmlspecialchars($_GET['keywords']) : '' ?>" />
            <input
                type="text"
                name="location"
                placeholder="Location"
                class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none" value="<?= isset($_GET['location']) ? htmlspecialchars($_GET['location']) : '' ?>" />
            <button
